...
// task #6
const okayAmount = (current, recommended) =>
  current > recommended * 0.9 && current < recommended * 1.1;

console.log(dogs.some(dog => okayAmount(dog.curFood, dog.recommendedFood)));

// task #7
const okayEatingDogs = dogs.filter(dog =>
  okayAmount(dog.curFood, dog.recommendedFood)
);
